...
export function useCommonLogsColumns(isAdmin: boolean): ColumnDef<UsageLog>[] {
  ...
  // costly here because these cells parse and format every log row.
      ...
      columns.push(
        ...
        },
        {
          ...
          cell: function IpCell({ row }) {
            ...
            // autoColor keyed by the IP itself: identical client IPs share a
            // badge color, so requests from one machine line up visually.
            return (
              <StatusBadge
                label={log.ip}
                autoColor={log.ip}
