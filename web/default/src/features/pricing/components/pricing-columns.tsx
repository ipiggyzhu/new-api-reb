...
export function usePricingColumns(
  ...
  // time, which throws away the row-level memoization the table relies on. The
  // deps are the destructured primitives rather than `options`, which the
  // caller rebuilds as an object literal on every render.
  return useMemo<ColumnDef<PricingModel>[]>(
    () => [
      // Model column
      {
